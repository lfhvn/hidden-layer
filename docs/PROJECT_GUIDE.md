...
- **What**: FastAPI backend for training Sparse Autoencoders and discovering interpretable features
...
- **What**: Daily research digest tool (arXiv, blogs) with optional Substack publishing
- **Quick Start**: See [README](../ai_research_aggregator/README.md)
- **Documentation**: [README](../ai_research_aggregator/README.md)
...
Web tools share infrastructure with research projects (see `web-tools/shared/`), include Docker Compose for deployment, and split into backend (FastAPI) and frontend (Next.js).
...
- Setup issues: See [SETUP.md](SETUP.md) and run `python check_setup.py`
...
| Latent Lens | ✅ Active | 1 | API only | No |
| CALM | ✅ Active | 0 | ❌ | No |
