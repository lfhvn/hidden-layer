...
def win_rate_comparison(
    task_input: str, output_a: str, output_b: str, provider: str = None, model: str = None
) -> Dict[str, Any]:
    """
...
def evaluate_task(task: Dict[str, Any], output: str, eval_type: Optional[str] = None) -> Dict[str, float]:
    """
    ...
    if eval_type == "exact_match" and "expected" in task:
        ...
        judge_result = llm_judge(task["input"], output, criteria=task.get("criteria", "overall quality"))
