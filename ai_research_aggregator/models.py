...
class SourceName(Enum):
    ...
    HUGGINGFACE_BLOG = "huggingface_blog"
    MS_RESEARCH_BLOG = "ms_research_blog"
    ELEUTHERAI_BLOG = "eleutherai_blog"
    MISTRAL_BLOG = "mistral_blog"
    TOGETHER_BLOG = "together_blog"
    AI2_BLOG = "ai2_blog"
    COHERE_BLOG = "cohere_blog"
